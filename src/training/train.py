...
MEDICAL_CONSTRAINTS = {
    'implications': [
        ('Pneumonia', 'Infiltration', 0.0),
        ('Mass', 'Nodule', 0.0),
        ('Consolidation', 'Infiltration', 0.0),
        ('Pneumonia', 'Effusion', -0.2),
        ('Cardiomegaly', 'Edema', -0.1),
    ],
    'exclusions': [
        ('Pneumothorax', 'Effusion', 1.2),
        ('Emphysema', 'Fibrosis', 1.1),
        ('Atelectasis', 'Emphysema', 1.0),
        ('Hernia', 'Pneumothorax', 1.0),
    ],
}
